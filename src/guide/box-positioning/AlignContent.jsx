  ...
  const outputPanel = {
    ...
    output: (state,shape) => (
      <div className={`h-full flex-wrap gap-5 flex w-full ${state}`}>
        <span className={`p-2 h-fit border ${shape.style} border-blue-500`}>one</span>
        <span className={`p-2 h-fit border ${shape.style} border-blue-500`}>two</span>
        <span className={`p-2 h-fit border ${shape.style} border-blue-500`}>three</span>
        <span className={`p-2 h-fit border ${shape.style} border-blue-500`}>four</span>
        <span className={`p-2 h-fit border ${shape.style} border-blue-500`}>five</span>
